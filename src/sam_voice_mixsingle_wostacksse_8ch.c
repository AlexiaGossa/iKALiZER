...
void SAM_VOICE_MixSingleGranule_WithoutStackSSE_8ch ( SAM_VOICE * psamVoice, SAM_SFX * psamSFX, float fGlobalGain, DWORD dwLoopCount, float * pfSoftwareBuffer, DWORD dwSoftwareBufferChannelCount, DWORD dwParam )
{
    float       fGlobalGain16;
    ...
    {
        SAM_VOICE_MixSingleGranule_WithoutStackSSE_8ch_noresamp (
            psamVoice, 
            psamSFX, 
            fGlobalGain,
            dwLoopCount, 
...
void SAM_VOICE_MixSingleGranule_WithoutStackSSE_8ch_noresamp ( SAM_VOICE * psamVoice, SAM_SFX * psamSFX, float fGlobalGain, DWORD dwLoopCount, float * pfSoftwareBuffer, DWORD dwSoftwareBufferChannelCount, DWORD dwParam )
{
    float       fGlobalGain16;
    float       *interpolation_fStackValue;
