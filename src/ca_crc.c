...
unsigned long ca_crcfast_lut[256] = {
...
unsigned long ca_crcturbo_lut[1252] = {
0xdbc09577, 0x7a5cf72c, 0xece675d1, 0xfc8f8cbb, 0x5bf6c7dd, 0xd660ce2f, 0xf7d10567, 0x13b19376, 
0xbad7de19, 0xc72fec88, 0x41ab9930, 0xcb16f393, 0x3f53d648, 0x3683af22, 0xc07b2a4a, 0x4ab8f6e8, 
0x6de92a26, 0x768604e4, 0x2ecef459, 0x67204a53, 0xd0028d24, 0x2fe52048, 0x471e5012, 0x95d98169, 
0x45836fba, 0x0ed38066, 0xdb5e66b8, 0x4c6e9308, 0xf7fe0d1d, 0x7a7103e9, 0x9c96df27, 0x8ea8b196, 
...
unsigned long ca_crc32_lut[256] = {
...
#define CA_CRC_DO1(buf)     crc = ca_crc32_lut[((int)crc ^ (*buf++)) & 0xff] ^ (crc >> 8);
#define CA_CRC_DO2(buf)     CA_CRC_DO1(buf); CA_CRC_DO1(buf);
#define CA_CRC_DO4(buf)     CA_CRC_DO2(buf); CA_CRC_DO2(buf);
#define CA_CRC_DO8(buf)     CA_CRC_DO4(buf); CA_CRC_DO4(buf);


void CA_GetCRCTurbo ( unsigned char * pData, long lSize, unsigned long * pdwCRC )
{
    unsigned long crc;
    unsigned char bDataEnd[8];
    ...
    if (lSize>=8)
    {
        __asm {
            ...
            _loop:
                ...
                xor         ecx, ca_crcturbo_lut[eax]
                add         edi, 8
                //ror         ecx, 1
                xor         ecx, ca_crcturbo_lut[ebx+128]
...
void CA_GetCRCFast ( unsigned char * pData, long lSize, unsigned long * pdwCRC )
{
    unsigned long crc;
    unsigned char bDataEnd[8];
    ...
    *pdwCRC = crc ^ 0xffffffffL;    
}



void CA_GetCRC32 ( unsigned char * pData, long lSize, unsigned long * pdwCRC )
{
    unsigned long crc;
    ...
    {    
        __asm {
            ...
            _loop:
                ...
                xor     al, cl
                shr     ecx, 8
                xor     ecx, ca_crc32_lut[eax*4]
                
                xor     bl, cl
                shr     ecx, 8
                xor     ecx, ca_crc32_lut[ebx*4]
