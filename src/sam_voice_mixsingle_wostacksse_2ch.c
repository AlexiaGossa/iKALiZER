...
void SAM_VOICE_MixSingleGranule_WithoutStackSSE_2ch ( SAM_VOICE * psamVoice, SAM_SFX * psamSFX, float fGlobalGain, DWORD dwLoopCount, float * pfSoftwareBuffer, DWORD dwSoftwareBufferChannelCount, DWORD dwParam )
{
    float       fGlobalGain16;
    ...
    {
        SAM_VOICE_MixSingleGranule_WithoutStackSSE_2ch_noresamp (
            psamVoice, 
            psamSFX, 
            fGlobalGain,
            dwLoopCount, 
    ...
    __asm {
            ...
            _loop_render:
                ...
                mulss       xmm0, [esi+edx+  SAM_RENDER254.fDelayGain]//SAM_wi512_fRender_DelayGain_LUT+[esi+edx]
                mulss       xmm1, [esi+edx+4+SAM_RENDER254.fDelayGain]//SAM_wi512_fRender_DelayGain_LUT+[esi+edx+4]
...
void SAM_VOICE_MixSingleGranule_WithoutStackSSE_2ch_noresamp ( SAM_VOICE * psamVoice, SAM_SFX * psamSFX, float fGlobalGain, DWORD dwLoopCount, float * pfSoftwareBuffer, DWORD dwSoftwareBufferChannelCount, DWORD dwParam )
{
    float       fGlobalGain16;
    float       *interpolation_fStackValue;
